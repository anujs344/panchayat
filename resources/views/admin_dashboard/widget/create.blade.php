                    ...
                    <x-slot name="content">
                        ...
                        <form action="{{route('admin.widget.store')}}" method="post">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <input type="number" name="order" class="form-control" placeholder="Order" min="1" value="1" required>
                            </div>
                            {{-- visibility --}}
                            <div class="col-12 mt-3">
                            ...
                            <div class="col-12 mt-3 d-flex justify-content-end">
                                <button type="submit" name="status" value="1" class="btn btn-primary btn-sm">Add Widget</button>
                            </div>
                        </form>
                    </x-slot>
                </x-bootstrap.card>
