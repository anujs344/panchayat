            ...
            <div class="col">
                <x-bootstrap.card>
                    ...
                    <x-slot name="controls">
                        <a href="{{ route('admin.widget.view') }}" role="button" class="btn btn-primary btn-sm d-flex align-items-center">
                    ...
                    <x-slot name="content">
                        ...
                        <form action="{{route('admin.widget.update', [$widget->id])}}" method="post">
                            @csrf
                            {{-- title --}}
                            <div class="col-12 mt-3">
                                <label class="form-label">Title</label>
                                <input type="text" name="title" class="form-control" placeholder="Title" value="{{ucwords($widget->title)}}" required>
                            </div>
                            {{-- order --}}
                            <div class="col-12 mt-3">
                                <label class="form-label">Order</label>
                                <input type="number" name="order" class="form-control" placeholder="Order" min="1" value="{{$widget->widget_order}}" required>
                            </div>
                            {{-- visibility --}}
                            <div class="col-12 mt-3">
                                <div class="row g-sm-2 align-items-center">
                                    ...
                                    <div class="col-md-1 col-sm-12 ps-sm-2">
                                    ...
                                    @else
                                    <div class="col-md-1 col-sm-12 ps-sm-2">
                                        <input type="radio" id="rb_visibility_1" class="polaris" name="visibility" value="1">
                                        <label for="rb_visibility_1" class="cursor-pointer">Show</label>
                                    </div>
                                    <div class="col-md-1 col-sm-12 ps-sm-2">
                                        <input type="radio" id="rb_visibility_2" class="polaris" name="visibility" value="0" checked>
                                        <label for="rb_visibility_2" class="cursor-pointer">Hide</label>
                                    </div>
                                    @endif
                                </div>
                            ...
                            <div class="col-12 mt-3 d-flex justify-content-end">
                                <button type="submit" name="submit" class="btn btn-primary btn-sm">Update Widget</button>
                            </div>
                        </form>
                    </x-slot>
                </x-bootstrap.card>
