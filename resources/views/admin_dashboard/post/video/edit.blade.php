...
<div class="page-wrapper">
    <div class="page-content">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <div class="fs-5 fw-bold text-dark">Edit Video</div>
        ...
        <form action="{{ route('admin.post.update', [$post->id, 'post_type'=>$post->post_type]) }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card radius-10 w-100">
                        <div class="card-body">
                            <div class="fw-bold">Get Video from URL</div>
                            <div class="col-12 mt-3">
                                <label class="form-label">Video URL</label>
                                <small>(Youtube)</small>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="video_url" id="video_url" value="{{$post->video_url}}" placeholder="Video URL">
                                    <button class="btn btn-outline-success btn-sm" type="button" onclick="get_video_from_url()">Get Video</button>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Video Embed Code</label>
                                    <textarea class="form-control text-embed" name="video_embed_url" id="video_embed_code" placeholder="Video Embed Code" style="height: auto">{{$post->video_embed_url}}</textarea>
                                </div>
                                <iframe src="{{$post->video_embed_url}}" id="video_embed_preview" frameborder="0" allow="encrypted-media" allowfullscreen class="video-embed-preview"></iframe>
                            </div>
                        </div>
                    </div>
                    {{-- main post image --}}
                    <div class="card radius-10 w-100">
                        <div class="card-body">
                            ...
                            <div id="post_select_image_container" class="post-select-image-container">
                                ...
                                @elseif (isset($post->opt_image_url))
                                <img src="{{$post->opt_image_url}}" alt="" style="object-fit: contain">
                                <a id="btn_delete_post_main_image" class="btn text-white btn-sm btn-delete-selected-file-image">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/></svg>
                                </a>
                                @else
