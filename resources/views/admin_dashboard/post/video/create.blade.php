...
<div class="page-wrapper">
    <div class="page-content">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <div class="fs-5 fw-bold text-dark">Add Video</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control text-embed" name="video_embed_url" id="video_embed_code" placeholder="Video Embed Code" style="height: auto"></textarea>
                                </div>
                    ...
                    <div class="card radius-10 w-100">
                        <div class="card-body">
                            <div class="d-flex flex-column fs-6 mb-3">
                                <div class="fw-bold">Video Thumbnail</div>
                                <small class="small">Image for video</small>
                            </div>
