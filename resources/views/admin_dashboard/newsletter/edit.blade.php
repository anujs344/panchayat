                    ...
                    <x-slot name="content">
                        ...
                        <form action="{{route('admin.newsletter.update', [$newsletter->id])}}" method="post">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="Title" value="{{ucwords($newsletter->title)}}" required>
                            </div>
                            {{-- content --}}
                            ...
                            <div class="col-12 mt-3 d-flex justify-content-end">
                                <button type="submit" name="submit" value="1" class="btn btn-primary btn-sm">Update Newsletter</button>
                            </div>
                        </form>
                    </x-slot>
                </x-bootstrap.card>
