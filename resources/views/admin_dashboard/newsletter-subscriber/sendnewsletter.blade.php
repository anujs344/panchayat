            ...
            <div class="col-12">
                <x-bootstrap.card>
                    ...
                    <x-slot name="content">
                        ...
                        <form action="{{route('admin.newsletter.subscriber.send')}}" method="post">
                            @csrf
                            {{-- subscriber email --}}
                            <div class="col-12 mt-3">
                                <label class="form-label">Send to</label>
                                <input type="text" name="email" class="form-control" data-role="tagsinput" placeholder="Email" required>
                                <small>(Type email and hit enter)</small>
                            </div>
                            {{-- subject --}}
                            <div class="col-12 mt-3">
                            ...
                            <div id="main_editor" class="mt-3">
                                ...
                                <textarea class="tinyMCE form-control" name="content">{{$newsletter->content}}</textarea>
                            </div>
                            {{-- publish --}}
                            <div class="col-12 mt-3 d-flex justify-content-end">
                                <button type="submit" name="submit" value="1" class="btn btn-primary btn-sm">Send</button>
                            </div>
                        </form>
                    </x-slot>
                </x-bootstrap.card>
